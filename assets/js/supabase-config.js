...
// You can obtain these from the Supabase dashboard -> Settings -> API
...
// IMPORTANT: Keep the anon key public (it's safe to be in client code). Do NOT commit your SUPABASE_SERVICE_ROLE_KEY.
